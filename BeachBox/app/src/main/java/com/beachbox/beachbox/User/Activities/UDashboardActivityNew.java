...
//        frame = (FrameLayout) findViewById(R.id.frame);
    ...
    private void CheckPermission() {
                ...
                || (ActivityCompat.checkSelfPermission(UDashboardActivityNew.this, permissionsRequired[3]) != PackageManager.PERMISSION_GRANTED ))
        {
                    ...
                    || ActivityCompat.shouldShowRequestPermissionRationale(UDashboardActivityNew.this,permissionsRequired[3]))
            {
                ...
                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(UDashboardActivityNew.this);
   ...
   /* private void setButtonsEnabledState() {
    ...
    private void updateUI() {
        ...
        //latitudeLabel.setText(""+mCurrentLocation.getLatitude());

        // longitudeLabel.setText(""+mCurrentLocation.getLongitude());
