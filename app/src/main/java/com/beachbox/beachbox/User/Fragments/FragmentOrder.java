...
/**
 * This class used for displaying upcoming orders and order history.
...
public class FragmentOrder extends Fragment implements APIRequest.ResponseHandler {
    ...
    public void onSuccess(BaseResponse response) {
        if (isAdded() && getActivity() != null) {
            ...
            if (response.getApiName()==Config.API_GET_UPCOMING_ORDER) {// upcoming order res
            ...
            } else if (response.getApiName()==Config.API_GET_HISTORY_ORDER){// order history res
