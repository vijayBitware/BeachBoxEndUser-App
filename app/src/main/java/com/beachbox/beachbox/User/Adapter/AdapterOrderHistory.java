...
/**
 * This class used for showing order history.
...
public static class ViewHolder {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.linearRatingText = (LinearLayout)convertView.findViewById(R.id.linearRatingText);
       ...
       // getFormatedDateTime(arrRestaurantList.get(position).getOrderedDate());
        ...
        if (arrRestaurantList.get(position).getRating() == null){
            holder.linearRatingText.setVisibility(View.VISIBLE);
            ...
            holder.linearRatingText.setVisibility(View.GONE);
            int rating =  arrRestaurantList.get(position).getRating().intValue();
            float rate = Float.parseFloat(""+arrRestaurantList.get(position).getRating().floatValue());

            double s = arrRestaurantList.get(position).getRating();
            String str = String.valueOf(s);
            holder.ratingBar.setRating(Float.parseFloat(str));

            //holder.ratingBar.setRating(rate);
            //holder.ratingBar.setIsIndicator(true);
            holder.tv_restaurantRating.setText(String.valueOf(rating));
            System.out.println("*******************rating*************"+arrRestaurantList.get(position).getRating());
            //holder.ratingBar.setRating(Float.parseFloat(""+arrRestaurantList.get(position).getRating()));
        }
