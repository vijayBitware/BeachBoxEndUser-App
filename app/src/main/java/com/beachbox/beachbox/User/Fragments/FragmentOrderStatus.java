...
/**
 * This class used for displaying order status and delivery boy current status on map.
...
public class FragmentOrderStatus extends Fragment implements GoogleMap.OnMarkerClickListener, GoogleMap.OnMapClickListener, ViewSwitcher.ViewFactory, APIRequest.ResponseHandler {
    ...
    //display data on delivery boy status
    ...
    public void onSuccess(BaseResponse response) {
        if (response.getApiName() == Config.API_CANCEL_PENDING_ORDER) {// cancel order res
        ...
        if (response.getApiName() == Config.API_UPDATE_DELIVERY_BOY_LOCATION) {// update del boy res
                           ...
                           // System.out.println("********orderType***********if");
                            handler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (isInternetPresent) {
                                        if (mNavigation.equals("fromOrderHistory") || mNavigation.equals("Notification")) {
