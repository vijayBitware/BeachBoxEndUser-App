    ...
    private void init() {
        ...
        tv_signIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                cd = new ConnectionDetector(ActivitySignIn.this);
                isInternetPresent=cd.isConnectingToInternet();
                if(isInternetPresent){
 ...
 */
    ...
    //get data from fb and send to server
    ...
    public void onSuccess(BaseResponse response) {
        if(response.getApiName() == Config.API_SIGNIN){      //when SingIn response API is called
            ...
            if(loginResponse.getIsSuccess()){
                editor.putString("IsCardParmanant","Yes");

                editor.putString("card_cc_transaction_id",loginResponse.getDefault_creditcard());
                editor.putString("getSelectedCard",loginResponse.getDefault_creditcard());
                editor.putString("card_card_id",loginResponse.getDefault_creditcard_id());
