...
/**
 * This class used for displaying list of added cards.
...
public class FragmentPaymentCardList extends Fragment {
    ...
    private void init() {
        System.out.println("**********payment frg***********");
                ...
                try {
                    ...
                    if (isSuccess) {
                        ...
                        for (int i = 0; i < jsonArray.length() ; i++) {
                            ...
                            modelCardList.setIsDefault(object.getString("is_default"));
                            System.out.println("*****default*******"+object.getString("is_default"));
